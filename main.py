...
_jwt_token_refreshed: Optional[str] = None
_jwt_last_refresh_at: Optional[float] = None  # epoch sec, for status endpoint
_jwt_last_refresh_error: Optional[str] = None  # last exception message when refresh failed (for /jwt-status)
